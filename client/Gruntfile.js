...
//                    ]
        ...
        replace: {
          dist: {
            ...
            files: [
              // By setting the src and dest to the same location, we overwrite the file once it is modified
              // if you need to see the temporary files generated by this step, you can change
              // dest: '.' to dest: './intermediate' (or whatever -- but this will break the remainder of the flow)

              {expand: true, flatten: false, src: ['<%= yeoman.dist %>/html/**/*.html'], dest: '.'}
            ]
          }
        },
