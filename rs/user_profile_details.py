...
class UserProfileDetails:
    ...
    else: # language_build -- no kisses or winks
       ...
       or settings.BUILD_NAME == "lesbian_build":
        turn_ons_checkbox_fields = {
            'turn_ons' : {
                ...
                'choices' : [
                    ('communication',) + ugettext_tuple(ugettext('Communication')),
                    # ('clean',) + ugettext_tuple(ugettext('Clean')),
                    ('discretion',) + ugettext_tuple(ugettext('Discretion')),
                    ('gentle',) + ugettext_tuple(ugettext('Gentle')),
                    ('massage',) + ugettext_tuple(ugettext('Massage')),
        ...
        adult_checkbox_fields = {
            'erotic_encounters' : {
                ...
                'choices' : [
                    ...
                    # ('adventurous_sex',) + ugettext_tuple(ugettext('Adventurous sex')),
                    ...
                    ('meet_for_a_coffee',) + ugettext_tuple(ugettext('Meet for a coffee')),
                    ...
                    ('fantasies',) + ugettext_tuple(ugettext('Explore fantasies')),
                    ...
                    ('transvestism',) + ugettext_tuple(ugettext('Transvestism')),
