        ...
        adult_checkbox_fields = {
            'erotic_encounters' : {
                ...
                'choices' : [
                    ...
                    ('use_dildo',) + ugettext_tuple(ugettext('Use a dildo')),
                    ('use_penis_pump',) + ugettext_tuple(ugettext('Use a penis pump')),
                    ('use_vibrator',) + ugettext_tuple(ugettext('Use a vibrator')),
