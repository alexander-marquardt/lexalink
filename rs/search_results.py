...
from rs import profiles_summary
import store_data
    ...
    try:       
        ...
        while len_query_results_currently_stored < query_size:
            ...
            if len_new_query_results == 0:
                ...
                generated_html_body +=  profiles_summary.generate_html_for_list_of_profiles(request, viewer_userobject, new_query_results_keys, display_online_status)
                ...
                if type_of_search == "normal":
                    ...
                    generated_html_body += profiles_summary.generate_html_for_list_of_profiles(request, viewer_userobject, new_query_results_keys[:-1], display_online_status)
