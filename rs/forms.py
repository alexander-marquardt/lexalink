...
class FormUtils():
        ...
        try:
            ...
            if photo_object and ((not userobject_ref.user_is_marked_for_elimination and photo_object.is_approved) or is_primary_user):
                ...
                if userobject_ref.user_is_marked_for_elimination:
                    ...
                    generated_html += u'%s\n' % ugettext("Approving (within %(wait_hours)s hours)") % {'wait_hours': constants.PHOTO_APPROVAL_WAIT_HOURS}
                else:
                ...
                if photo_object_key != None:
                    ...
                    if not photo_object.is_private and photo_object.is_approved:
                        ...
                        if photo_object.is_private:
                            ...
                            # approved. 
                            title = ugettext("Approving photo for public (within %(wait_hours)s hours)") % {'wait_hours': constants.PHOTO_APPROVAL_WAIT_HOURS}
    ...
    @classmethod
    def generate_title_and_meta_description_for_current_profile(cls, lang_code, uid):
        ...
        try:
            ...
            base_title = profile_utils.get_base_userobject_title(lang_code, uid)
