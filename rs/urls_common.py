...
from rs import views, login, ajax, store_data, search_results, mailbox, contacts, \
     ...
     models, lang_settings, channel_support, vip_status_support, vip_paysafecard_payments, \
     vip_paypal_payments, sitemaps, mail_handlers, track_viewers, messages
...
urlpatterns = patterns('',
    ...
    url(r'^rs/iframe_html/$', views.iframe_html),
    ...
    (r'^rs/store_(?P<section_name>about_user[_dialog_popup]*)/(?P<owner_uid>[\w|-]+)/$', store_data.store_about_user),
    ...
    (r'^rs/ajax/get_(?P<section_name>about_user[_dialog_popup]*)_settings/(?P<uid>[\w|-]+)/[\w|-]+/$', ajax.get_about_user_settings),
    ...
    (r'^rs/ajax/load_(?P<section_name>about_user[_dialog_popup]*)/[\w|-]+/$', ajax.load_about_user),       
    ...
    (r'^rs/admin/admin_login', admin.admin_login),
    ...
    (r'^rs/admin/remove_old_email_authorization_model/$', admin.batch_run_passed_in_job, {
        'query_function_pointer': admin.remove_old_email_authorization_model_setup_query,
        'sub_processing_function_pointer' : admin.delete_model_sub_batch}),   
    (r'^rs/admin/delete_model_sub_batch/$', admin.delete_model_sub_batch), 
