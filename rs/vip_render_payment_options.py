...
def render_payment_options(request, userobject):
    ...
    try:
        ...
        if constants.THIS_BUILD_ALLOWS_VIP_UPGRADES:
            ...
            paypal_data = vip_paypal_payments.generate_paypal_data(request, userobject)
            paysafecard_data = vip_paysafecard_payments.generate_paysafecard_data(request, userobject)
