...
# Patch the reverse (url lookup) function to include language in the URL 
# (This is is an over-ride of the standard django behaviour)
...
def main():
  ...
  # set up logging to include DEBUG messages -- this is code added by ARM
